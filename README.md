...
`java -jar android_contentprovider_generator-1.9.4-bundle.jar -i <input folder> -o <output folder>`
...
This will produce `android_contentprovider_generator-1.9.4-bundle.jar` in the `target` folder.
